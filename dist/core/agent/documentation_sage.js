...
exports.DocumentationSage = void 0;
const base_agent_1 = require("./base_agent");
class DocumentationSage extends base_agent_1.BaseAgent {
    constructor() {
        super('Documentation Sage', 'Documentation and Knowledge Specialist', `You are the Documentation Sage, master of technical documentation and knowledge capture.
...
Use OpenAPI/Swagger style formatting.`;
    ...
    async createArchitectureDoc(task) {
...
7. Scalability considerations`;
    ...
    async generateMigrationGuide(task) {
...
7. Common issues and solutions`;
    ...
    async handleGeneric(task) {
        const result = await this.think(`Generate documentation for: ${JSON.stringify(task.payload)}`);
        return {
            success: true,
            result: {
...
exports.DocumentationSage = DocumentationSage;
//# sourceMappingURL=documentation_sage.js.map