...
exports.ArchitectPrime = void 0;
const base_agent_1 = require("./base_agent");
class ArchitectPrime extends base_agent_1.BaseAgent {
    constructor() {
        super('Architect Prime', 'Chief System Architect', `You are the Architect Prime, the chief system architect for TITAN++.
...
5. Suggested improvements`;
    ...
    async handleGeneric(task) {
        const result = await this.think(`Handle this architectural task: ${JSON.stringify(task.payload)}`);
        return {
            success: true,
            result: {
                response: result,
...
exports.ArchitectPrime = ArchitectPrime;
//# sourceMappingURL=architect_prime.js.map